...
unsigned int nStakeMinAge = 60 * 60 * 24 * 90;	// minimum age for coin age: 90d
unsigned int nStakeMaxAge = 60 * 60 * 24 * 180;	// stake age of full weight: 180d
unsigned int nStakeTargetSpacing = 1 * 60;			// 3 minute block spacing

int64 nChainStartTime = 1378523936;
...
int64 GetProofOfStakeReward(int64 nCoinAge, unsigned int nBits, unsigned int nTime)
{
    int64 nRewardCoinYear;
        ...
        // PeopleCoin: reward for coin-year is cut in half every 64x multiply of PoS difficulty
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in PeopleCoin
    bool fStrictPayToScriptHash = true; // Always active in PeopleCoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "PeopleCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "People Coin Sept. 6, 2013";
        CTransaction txNew;
		...
		txNew.strTxComment = "text: People Coin genesis block";
        ...
        block.nVersion = 1;
        block.nTime    = 1378523936;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 4220649;
        ...
        assert(block.hashMerkleRoot == uint256("0x8bb7977ec540903119e50b85dcf939ad08e8a9f70257e86591d2506098e4b45a"));
